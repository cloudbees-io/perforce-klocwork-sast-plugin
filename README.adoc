...
----
      ...
      - name: Scan with Klocwork SAST with custom config
        ...
        with:
          ...
          username:  ${{ vars.KLOCWORK_USERNAME }}
          ref: main
          project-name: 'my-security-project'
          build-spec-file:  '/tmp/kwinject.out'
          build-directory:  ${{ vars.KLOCWORK_BUILD_DIR }}
          build-tool:  ${{ vars.KLOCWORK_BUILD_TOOL }}
    ...
    steps:
      ...
      - name: Perforce Klocwork scan on C++ code
        ...
        with:
          ...
          token: ${{ secrets.KLOCWORK_APP_TOKEN }}
          username:  ${{ vars.KLOCWORK_USERNAME }}
          project-name: 'my-c-project'
          build-tool: 'make'
          build-directory: '/'
          build-options: 'make all --ignore-errors -j14'
  ...
  klocwork-scan-job:
    steps:
      ...
      - id: klocwork-step
        ...
        uses: cloudbees-io/perfornce-klocwork-sast-plugin@v1
      ...
      - id: print-outputs-from-klocwork-step
        ...
        run: |
            ...
            echo "Policy subject: ${{steps.klocwork-step.outputs.policy-subject}}"
...
jobs:
  job1:
    outputs:
      ...
      klocwork-job-output-policy-subject: ${{ steps.klocwork-step.outputs.policy-subject }}
    steps:
      - name: check out source code
        uses: cloudbees-io/checkout@v1
        with:
    ...
    steps:
      - id: print-outputs-from-job1
        ...
        run: |
          ...
          echo "Policy subject: ${{ needs.job1.outputs.klocwork-job-output-policy-subject }}"
